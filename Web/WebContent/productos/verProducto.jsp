...
<main role="main">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col col-xs-6">
				<p><strong class="mr-2">Código:</strong><span class="badge badge-pill badge-info">123ABC456</span></p>
			</div>
		</div>
		<div class="row">
			<div class="col col-xs-6">
				<p><strong class="mr-2">Descripción:</strong>Gaseosa de Cola</p>
			</div>
			<div class="col col-xs-6">
		...
		<div class="row">
			<div class="col col-xs-12">
				<p><strong class="mr-2">Presentación:</strong>Botella de 2.25lt</p>
			</div>	
		</div>
		...
		<div class="row">
			<div class="col col-xs-12">
				<ul class="list-group list-group-horizontal">
				  ...
				  <li class="list-group-item flex-fill"><strong class="mr-2">Mínimo</strong><span class="badge badge-pill badge-info">50</span></li>
